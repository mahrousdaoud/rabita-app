          ...
          >
            ...
            <div className="flex gap-2 mt-4">
              ...
              <button
                ...
                className="flex-1 bg-teal-900 text-sand-50 py-2.5 rounded-xl font-body font-semibold disabled:opacity-50"
              >
                إرسال
              </button>
              ...
              <button
                ...
                className="px-4 border rounded-xl font-body"
              >
                إلغاء
              </button>
        ...
        return (
          ...
          >
            ...
            <div className="flex justify-between gap-3">
              ...
              <span className="text-sm text-teal-800 font-body whitespace-nowrap">
                {m.date
                  ?.toDate?.()
                  ?.toLocaleString(
                    "ar-EG"
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              ...
              <button
                ...
                className={`py-2 rounded-lg text-sm font-body font-semibold ${
                  available
                    ? "bg-good/10 text-good border border-good"
                    : "bg-sand-50 text-ink/60 border border-ink/10"
                }`}
              >
                {available
                  ? "✓ فوت — متاح"
                  : "فوت — أكّد حضورك المتوقع"}
              </button>
              ...
              <button
                ...
                className="py-2 rounded-lg text-sm font-body font-semibold border border-bad/20 text-bad bg-bad/5"
              >
                أعتذر
              </button>
...
function StatCard({
  ...
  return (
    <div className="bg-white rounded-xl2 shadow-sm border border-teal-900/5 p-4 text-center">

      <p
        className={`font-display font-extrabold text-2xl ${color}`}
      >
        {value}
      </p>
